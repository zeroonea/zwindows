...
*/
        ...
        private static void Reset(AutomationElement trayWnd)
        {
            ...
            Win32Helper.SetWindowPos(taskListPtr, IntPtr.Zero, 0, 0, 0, 0, WindowPosFlags.TaskList);
        }
        ...
        private void LoopForPosition(object trayWndObj)
        {
            ...
            //var delay = OneSecond / _activeFramerate;
            //numberOfLoops = 1;
            //delay = 5000;
            var keepGoing = 0;
            while (keepGoing < numberOfLoops)
            {
                ...
                Task.Delay(Global.Settings.CenterTaskBarDelay).Wait();
            }
        ...
        private bool PositionLoop(AutomationElement trayWnd)
        {
            ...
            if (horizontal)
            {
                Win32Helper.SetWindowPos(taskListPtr, IntPtr.Zero, RelativePos(targetPos, horizontal, taskList, scale, trayBounds), 0, 0, 0,
                     WindowPosFlags.TaskList);
            ...
            {
                Win32Helper.SetWindowPos(taskListPtr, IntPtr.Zero, 0, RelativePos(targetPos, horizontal, taskList, scale, trayBounds), 0, 0,
                    WindowPosFlags.TaskList);
